...
public class CollectionItemArrayAdapter extends ArrayAdapter<CollectionItem> {

    private Context mContext;
    private String imageUrl;
    private CollectionItem postItem;
    private String titleEng;

    public CollectionItemArrayAdapter(Context context, List<CollectionItem> items, String title) {
        super(context, R.layout.collection_list_item, items);
        mContext = context;
        titleEng = title;
    }
